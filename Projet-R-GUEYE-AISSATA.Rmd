---
title: "projet_R_ENSAE_2023"
author: "GUEYE_Aissata"
date: "`r Sys.Date()`"
output:
  pdf_document:
    toc: yes
...
# Créer un nouveau jeu de données avec les variables souhaitées
nouveau_projet <- projet %>%
  select(sexe, q25, q12, q81)

# Créer un tableau croisé en utilisant la fonction table()
table_croisee <- table(nouveau_projet)

# Convertir le tableau en data.frame
table_df <- as.data.frame(table_croisee)

# Créer un résumé statistique avec gtsummary
summary_table <- tbl_summary(table_df)
...
•	Renommer la variable “country_destination” en “destination” et définir les valeurs négatives
comme manquantes.
